			...
			switch( command.getOperation() ) {
...

				{
					...
					if( returnGeneratedKeys ) {
						updateRecords = new ArrayList( recIdHandler.getFoundCount() );
					}
	...
	*/
	...
	public ResultSet getGeneratedKeys() {
		if( autoGeneratedKeys != null ) {
			...
			return new FmResultSet( Collections.EMPTY_LIST.iterator(), 0, new FmFieldList(), (FmConnection)statement.getConnection() );
		}
